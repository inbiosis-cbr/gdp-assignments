@extends('adminlte.customer.layout.auth')
...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form method="post" action="{{ url('/customer/register') }}">
      ...
      <div class="row">
        <div class="col-xs-12">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Register as customer</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    ...
    <br />
    <a href="{{ url('/customer/login') }}" class="btn btn-default btn-block btn-flat">Sign In My Account</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
