...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form method="post" action="{{ url('/staff/register') }}">
      ...
      <div class="row">
        <div class="col-xs-12">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Register as staff</button>
          <p class="small">
    ...
    <br />
    <a href="{{ url('/staff/login') }}" class="btn btn-default btn-block btn-flat">Sign In My Account</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
