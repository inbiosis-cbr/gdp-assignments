...
<html lang="en">
  <head>
    ...
    <title>
      Demo | Assignment from GDP
    </title>
    <!-- Bootstrap -->
    <link rel="stylesheet" type="text/css" href="themes/engage/assets/css/bootstrap.min.css">
    <!-- Main Style -->
    <link rel="stylesheet" type="text/css" href="themes/engage/assets/css/main.css">
    <!-- Responsive Style -->
    <link rel="stylesheet" type="text/css" href="themes/engage/assets/css/responsive.css">
    <!--Fonts-->
    <link rel="stylesheet" media="screen" href="themes/engage/assets/fonts/font-awesome/font-awesome.min.css">
    <link rel="stylesheet" media="screen" href="themes/engage/assets/fonts/simple-line-icons.css">    
     
    <!-- Extras -->
    <link rel="stylesheet" type="text/css" href="themes/engage/assets/extras/owl/owl.carousel.css">
    <link rel="stylesheet" type="text/css" href="themes/engage/assets/extras/owl/owl.theme.css">
    <link rel="stylesheet" type="text/css" href="themes/engage/assets/extras/animate.css">
    <link rel="stylesheet" type="text/css" href="themes/engage/assets/extras/normalize.css">
    <link rel="stylesheet" type="text/css" href="themes/engage/assets/extras/settings.css">

    <!-- Color CSS Styles  -->
    <link rel="stylesheet" type="text/css" href="themes/engage/assets/css/colors/orange.css" media="screen" />       
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="images">
              <img src="themes/engage/assets/img/about/plain-why-choose-us-2.png" alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-3">
            ...
            <div class="team-item wow fadeInUpQuick" data-wow-delay="1s">
              <figure class="team-profile">
                <img src="themes/engage/assets/img/team/team-01.jpg" alt="">
          ...
          <div class="col-sm-6 col-md-3">
            ...
            <div class="team-item wow fadeInUpQuick" data-wow-delay="1.4s">
             <figure class="team-profile">
                 <img src="themes/engage/assets/img/team/team-02.jpg" alt="">
                <figcaption class="our-team">
                  <div class="details">
                    <p class="content-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                   <div class="orange-line"></div>
          ...
          <div class="col-sm-6 col-md-3">
            ...
            <div class="team-item wow fadeInUpQuick" data-wow-delay="1.8s">
              <figure class="team-profile">
                  <img src="themes/engage/assets/img/team/team-03.jpg" alt="">
                <figcaption class="our-team">
                  <div class="details">
                    <p class="content-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                   <div class="orange-line"></div>
          ...
          <div class="col-sm-6 col-md-3">
            ...
            <div class="team-item wow fadeInUpQuick" data-wow-delay="2.2s">
              <figure class="team-profile">
                <img src="themes/engage/assets/img/team/team-04.jpg" alt="">
                <figcaption class="our-team">
                  <div class="details">
                    <p class="content-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                   <div class="orange-line"></div>
          ...
          <div class="col-sm-12">
            <div id="testimonial-item" class="owl-carousel">
              <div class="item">
                <div class="testimonial-inner">
                  <div class="testimonial-images">
                    <img class="img-circle" src="themes/engage/assets/img/testimonial/img1.jpg" alt="">
                  </div>
              ...
              <div class="item">
                <div class="testimonial-inner">
                  <div class="testimonial-images">
                    <img class="img-circle" src="themes/engage/assets/img/testimonial/img2.jpg" alt="">
                  </div>
                  <div class="testimonial-content">
                    <p>
                      Quisque mollis lacus augue, a hendrerit leo tristique vitae. Mauris non ipsum molestie sagittis elit ac vulputate odio.
              ...
              <div class="item">
                <div class="testimonial-inner">
                  <div class="testimonial-images">
                    <img class="img-circle" src="themes/engage/assets/img/testimonial/img3.jpg" alt="">
                  </div>
                  <div class="testimonial-content">
                    <p>
                      Quisque mollis lacus augue, a hendrerit leo tristique vitae. Mauris non ipsum molestie sagittis elit ac vulputate odio.
              ...
              <div class="item">
                <div class="testimonial-inner">
                  <div class="testimonial-images">
                    <img class="img-circle" src="themes/engage/assets/img/testimonial/img4.jpg" alt="">
                  </div>
                  <div class="testimonial-content">
                    <p>
                      Quisque mollis lacus augue, a hendrerit leo tristique vitae. Mauris non ipsum molestie sagittis elit ac vulputate odio.
              ...
              <div class="item">
                <div class="testimonial-inner">
                  <div class="testimonial-images">
                    <img class="img-circle" src="themes/engage/assets/img/testimonial/img5.jpg" alt="">
                  </div>
                  <div class="testimonial-content">
                    <p>
                      Quisque mollis lacus augue, a hendrerit leo tristique vitae. Mauris non ipsum molestie sagittis elit ac vulputate odio.
...
">
        ...
        <div class="wow fadeInUpQuick" data-wow-delay=".9s">
          ...
          <div class="row" id="clients-scroller">
            <div class="client-item-wrapper">
              <img src="themes/engage/assets/img/clients/img1.png" alt="">
            </div>
            <div class="client-item-wrapper">
              <img src="themes/engage/assets/img/clients/img2.png" alt="">
            </div>
            <div class="client-item-wrapper">
              <img src="themes/engage/assets/img/clients/img3.png" alt="">
            </div>
            <div class="client-item-wrapper">
              <img src="themes/engage/assets/img/clients/img4.png" alt="">
            </div>
            <div class="client-item-wrapper">
              <img src="themes/engage/assets/img/clients/img5.png" alt="">
            </div>
            <div class="client-item-wrapper">
              <img src="themes/engage/assets/img/clients/img6.png" alt="">
            </div>
        ...
        <div class="row section">
          ...
          <div class="footer-widget col-md-3 col-xs-12 wow fadeIn" data-wow-delay=".5s">
            ...
            <div class="plain-flicker-gallery">
              <a href="#" title="Pan Masala"><img src="themes/engage/assets/img/flicker/img1.jpg" alt=""></a>
              <a href="#" title="Sports Template for Joomla"><img src="themes/engage/assets/img/flicker/img2.jpg" alt=""></a>
              <a href="" title="Apple Keyboard"><img src="themes/engage/assets/img/flicker/img3.jpg" alt=""></a>
              <a href="" title="Hard Working"><img src="themes/engage/assets/img/flicker/img4.jpg" alt=""></a>
              <a href="" title="Smile"><img src="themes/engage/assets/img/flicker/img5.jpg" alt=""></a>
              <a href="" title="Puzzle"><img src="themes/engage/assets/img/flicker/img6.jpg" alt=""></a>
            </div>
          </div><!-- Footer Widget Ends -->
    ...
    <!-- jQuery Load -->
    <script src="themes/engage/assets/js/jquery-min.js"></script>
    <!-- Bootstrap JS -->
    <script src="themes/engage/assets/js/bootstrap.min.js"></script>
    <!--Text Rotator-->
    <script src="themes/engage/assets/js/jquery.mixitup.js"></script>
    <!--WOW Scroll Spy-->
    <script src="themes/engage/assets/js/wow.js"></script>
    <!-- OWL Carousel -->
    <script src="themes/engage/assets/js/owl.carousel.js"></script>
 
    <!-- WayPoint -->
    <script src="themes/engage/assets/js/waypoints.min.js"></script>
    <!-- CounterUp -->
    <script src="themes/engage/assets/js/jquery.counterup.min.js"></script>
    <!-- ScrollTop -->
    <script src="themes/engage/assets/js/scroll-top.js"></script>
    <!-- Appear -->
    <script src="themes/engage/assets/js/jquery.appear.js"></script>
    <script src="themes/engage/assets/js/jquery.vide.js"></script>
     <!-- All JS plugin Triggers -->
    <script src="themes/engage/assets/js/main.js"></script>
    @php
    /*
    <script src="themes/engage/assets/js/color-switcher.js"></script>
    */
    @endphp
